        ...
        try:
            ...
            if "framework" in query_lower or "api" in query_lower:
                mock_results = [
                    ...
                    QueryResult(
                        ...
                        metadata={"tags": ["framework", "python"], "source": "user_input"},
                    ),
                ]
            ...
            if filters:
                ...
                filtered_results = [
                    ...
                    if self._matches_filters(result.metadata or {}, filters)
                ]
            ...
            logger.info(f"Query returned {len(limited_results)} results in {query_time_ms}ms")
